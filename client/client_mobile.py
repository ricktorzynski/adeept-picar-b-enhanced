...
def loop():                       #GUI
    ...
    while True:
        ...
        root.geometry('400x630')  #Main window size, middle of the English letter x.
        ...
        E1.place(x=140,y=40)                             #Define a Entry and put it in position

        l_ip_3=tk.Label(root,width=10,text='IP Address:',fg=color_text,bg='#000000')
        l_ip_3.place(x=135,y=15)                         #Define a Label and put it in position

        Btn14= tk.Button(root, width=8, text='Connect',fg=color_text,bg=color_btn,command=connect_2,relief='ridge')
        Btn14.place(x=270,y=35)                          #Define a Button and put it in position
        ...
        Btn0.place(x=100,y=140) # Backward
        Btn1.place(x=100,y=100) # Forward
        Btn2.place(x=30,y=140)  # Left
        Btn3.place(x=170,y=140) # Right
        Btn4.place(x=170,y=185) # Stop
        Btn5.place(x=30,y=185)  # Follow
        
        Btn6.place(x=30,y=275) # Left
        Btn7.place(x=170,y=275) # Right
        Btn8.place(x=100,y=275) # Down
        Btn9.place(x=100,y=230) # Up
        Btn10.place(x=100,y=315) # home

        Btn11.place(x=270,y=75) # exit
